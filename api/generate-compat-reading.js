...
- 呼称: 本人は「あなた」、相手はユーザープロンプトに渡される名前(例:「ゆうさん」)で呼ぶ。「本人様」「相手様」は禁止
...
### スコア別のトーン指針(mbt_n の値で判断)

- 85+ 点: 非常に高い親和性。「互いを映す鏡のような相性」「深い相互理解」
- 70-84 点: 強い共鳴。「価値観が近く、共鳴し合える関係」
- 60-69 点: バランスの取れた相性。「共通点と違いがバランスよく混在」
- 48-59 点: 意識的な歩み寄りが必要。「根本的な思考パターンが異なる」「MBTI 的には摩擦が生じやすい組み合わせ」
- 48 点未満: 根本的に異なる思考パターン。「思考と感情のプロセスが大きく異なり、互いの言語が通じにくい」

重要: mbt_n が 48-59 の場合、「補完的」「秀逸な相性」等の肯定的すぎる表現は絶対に使わない。
...
本人は「あなた」、相手は「${partnerName}」と呼んでください。「本人様」「相手様」は使わないでください。
